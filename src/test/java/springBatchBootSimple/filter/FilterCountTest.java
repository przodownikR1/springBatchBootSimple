package springBatchBootSimple.filter;
...
@ContextConfiguration(locations = { "classpath:filter_countTest.xml" })
...
public class FilterCountTest {
    ...
    public void shouldReadWrite() throws SQLException, JobExecutionAlreadyRunningException, JobRestartException, JobInstanceAlreadyCompleteException,
        ...
        JobExecution execution = jobLauncher.run(filterCountJob, new JobParameters(params));
