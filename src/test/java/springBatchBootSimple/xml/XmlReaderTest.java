package springBatchBootSimple.xml;
...
@ContextConfiguration(locations = { "classpath:XmlReaderTest.xml" })
...
public class XmlReaderTest {
    ...
    public void shouldReadWrite() throws SQLException, JobExecutionAlreadyRunningException, JobRestartException, JobInstanceAlreadyCompleteException,
        ...
        JobExecution execution = jobLauncher.run(xmlReadJob, new JobParameters(params));
