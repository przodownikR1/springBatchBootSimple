package springBatchBootSimple.fixed;
...
import pl.java.scalatech.job.FixedLengthPersonJob;

import com.google.common.collect.Maps;

@Slf4j
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = { BatchConfig.class, FixedLengthPersonJob.class })
@ActiveProfiles(profiles = { "fixed", "java" })
public class FixedLengthFileJavaConfigJobTest {
    ...
    public void shouldTaskletWork() throws JobExecutionAlreadyRunningException, JobRestartException, JobInstanceAlreadyCompleteException,
        ...
        JobExecution execution = jobLauncher.run(fixedJob, new JobParameters(params));
